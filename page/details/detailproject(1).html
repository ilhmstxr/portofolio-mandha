    ...
    <div class="max-w-[1728px] w-full min-h-[1084px] bg-white px-10 lg:px-16 pb-16">
      ...
      <div class="pt-8 mb-6">
        ...
        <span class="text-sm text-gray-500 ml-1">
          / Projects &gt; Rumah Hemat Energi (Rumah Batu Bata)
        </span>
      </div>
        ...
        <section class="bg-[#e3e3e3] rounded-[24px] shadow-md px-10 py-10">
          <div class="max-w-[560px]">
            ...
            <h2 class="text-sm font-semibold mb-6">
              Rumah Hemat Energi (Rumah Batu Bata)
            </h2>

            <!-- Deskripsi -->
            <p class="text-[11px] leading-relaxed mb-6 text-gray-800">
              Rumah hemat energi dari bata bata adalah hunian yang memanfaatkan
              sifat batu bata dalam menjaga suhu ruangan tetap stabil. Desainnya
              dibuat dengan ventilasi dan pencahayaan alami yang optimal, sehingga
              mengurangi penggunaan listrik untuk penerangan dan pendingin ruangan.
              Rumah ini ramah lingkungan dan efisien dalam jangka panjang.
            </p>
            ...
            <div class="space-y-1 text-[11px] text-gray-900">
              <p>
                ...
                <span class="ml-1">09 - 05 - 2023</span>
              </p>
              <p>
                <span class="font-semibold">Pengerjaan :</span>
                <span class="ml-1">Tim</span>
              </p>
              <p class="break-all">
            ...
            <div class="mt-8">
              <div class="inline-flex flex-col items-center justify-center bg-black text-white rounded-full px-8 py-3">
                <span class="text-sm font-semibold">3 Bulan</span>
