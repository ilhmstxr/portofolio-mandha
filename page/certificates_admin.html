...
<div class="w-full flex">
  ...
  <aside class="w-[320px] bg-black text-white min-h-screen p-8 flex flex-col justify-between">
    ...
    <div class="flex flex-col items-center mt-4 w-full">
      <img src="../Assets/LOGO.png" class="h-32 mb-4" />
      ...
      <nav class="w-full space-y-3 text-sm">
        ...
        <a class="block bg-gray-700 px-4 py-2 rounded transition" href="certificates_admin.html">Certificates</a>
...
<a href="editcertificates_admin.html"
...
<a href="editcertificates_admin.html" class="hover:text-white">Edit Certificate</a>
</p>
