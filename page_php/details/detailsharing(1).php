    ...
    <div class="grid grid-cols-1 lg:grid-cols-[1.1fr,1fr] gap-10 items-start">
      ...
      <section class="bg-[#e3e3e3] rounded-[24px] shadow-md px-10 py-10">
        <div class="max-w-[560px]">
          ...
          <!-- Deskripsi (font diperbesar) -->
          <p class="text-sm leading-relaxed mb-6 text-gray-800">
            MATLAB adalah software komputasi yang digunakan untuk analisis data, perhitungan matematis, dan pemrograman dengan basis utama matriks. 
            Program ini banyak dimanfaatkan dalam bidang teknik, sains, matematika, dan penelitian karena mampu memproses data dalam jumlah besar dengan cepat dan akurat. 
            MATLAB menyediakan berbagai toolbox seperti signal processing, control system, image processing, dan machine learning yang memudahkan pengguna dalam melakukan simulasi, 
            pemodelan sistem, serta visualisasi grafik secara interaktif. Dengan antarmuka yang mudah dipahami dan bahasa pemrograman yang fleksibel, MATLAB menjadi alat yang efektif 
            untuk menyelesaikan perhitungan kompleks dan eksperimen numerik.
          </p>
