...
<body class="bg-white text-gray-900 font-sans">
  ...
  <!-- WRAPPER PROTOTYPE 1728 x 2758 -->
  <div class="max-w-[1728px] mx-auto min-h-[2350px]">
  ...
  <nav class="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-black to-[#bca2a2] text-white shadow-md">
    ...
    <!-- ABOUT ME SECTION -->
    <section class="max-w-[1100px] mx-auto flex flex-col md:flex-row items-center bg-gradient-to-r from-black to-[#735555] rounded-2xl p-10 mb-20 text-white shadow-lg">
      ...
      <div class="flex-1 text-center md:text-left">
        ...
        <p class="text-sm md:text-base leading-relaxed mb-6">
          ...
          Saya aktif mengeksplorasi bagaimana teknologi dan manajemen dapat diterapkan untuk menyelesaikan masalah operasional serta mendukung pengambilan keputusan di berbagai konteks organisasi.
          <br><br>
          Dengan pengalaman dalam proyek akademik dan kegiatan kolaboratif, saya terus mengembangkan kemampuan dalam perencanaan, riset, desain proses, serta kerja tim. 
          Bagi saya, pembelajaran adalah perjalanan berkelanjutan, dan saya berkomitmen untuk selalu berkembang serta memberikan kontribusi terbaik dalam setiap kesempatan.
        </p>
...
<section class="text-center mb-10">
  ...
  <div class="flex flex-wrap justify-center gap-8 px-6 mb-10">
    ...
    <!-- Card PROJECTS -->
<a href="home_project.html" class="block">
  <div class="bg-black text-white rounded-xl w-80 h-24 flex items-center justify-between px-6 hover:-translate-y-1 transition cursor-pointer">
    <div class="text-left">
...
<!-- Card CERTIFICATES -->
<a href="home_certificates.html" class="block">
  <div class="bg-black text-white rounded-xl w-80 h-24 flex items-center justify-between px-6 hover:-translate-y-1 transition cursor-pointer">
    <div class="text-left">
...
<!-- Card SHARING -->
<a href="home_sharing.html" class="block">
  <div class="bg-black text-white rounded-xl w-80 h-24 flex items-center justify-between px-6 hover:-translate-y-1 transition cursor-pointer">
    <div class="text-left">
...
<section class="max-w-[1100px] mx-auto mb-16">
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <!-- Project 1: Rumah Batu Bata -->
    <a href="detailproject(1).html" 
      ...
      <div class="h-48 bg-gray-100">
        <img src="../Assets/PROJECT 1.png" alt="Rumah Batu Bata" class="w-full h-full object-cover">
      </div>

      <div class="bg-[#4B3C3C] text-white px-4 py-3 flex items-center justify-between">
        <div class="text-left leading-tight">
          <p class="text-sm font-semibold">Design ACAD</p>
          <p class="text-[11px] italic text-gray-200">Rumah Hemat Energi (Rumah Batu Bata)</p>
        </div>
        <img src="../Assets/PANAH 2.png" class="w-4 h-4 object-contain" alt="arrow">
      </div>
    </a>

    <!-- Project 2: Bench Press -->
    <a href="detailproject(2).html" 
       class="block bg-white border border-black/40 rounded-xl shadow-sm overflow-hidden transform hover:-translate-y-1 hover:shadow-lg transition">

      <div class="h-48 bg-gray-100">
        <img src="../Assets/PROJECT 2.png" alt="Bench Press" class="w-full h-full object-cover">
      </div>

      <div class="bg-[#4B3C3C] text-white px-4 py-3 flex items-center justify-between">
        <div class="text-left leading-tight">
          <p class="text-sm font-semibold">Design ACAD</p>
          <p class="text-[11px] italic text-gray-200">Bench Press</p>
        </div>
        <img src="../Assets/PANAH 2.png" class="w-4 h-4 object-contain" alt="arrow">
      </div>
    </a>

    <!-- Project 3: Mesin Pemotong Rumput -->
    <a href="detailproject(3).html" 
       class="block bg-white border border-black/40 rounded-xl shadow-sm overflow-hidden transform hover:-translate-y-1 hover:shadow-lg transition">

      <div class="h-48 bg-gray-100">
        <img src="../Assets/PROJECT 3.png" alt="Mesin Pemotong Rumput" class="w-full h-full object-cover">
      </div>

      <div class="bg-[#4B3C3C] text-white px-4 py-3 flex items-center justify-between">
        <div class="text-left leading-tight">
          <p class="text-sm font-semibold">Design ACAD</p>
          <p class="text-[11px] italic text-gray-200">Mesin Pemotong Rumput</p>
        </div>
        <img src="../Assets/PANAH 2.png" class="w-4 h-4 object-contain" alt="arrow">
      </div>
    </a>

    <!-- Project 4: Dispenser Hand Sanitizer -->
    <a href="detailproject(4).html" 
       class="block bg-white border border-black/40 rounded-xl shadow-sm overflow-hidden transform hover:-translate-y-1 hover:shadow-lg transition">

      <div class="h-48 bg-gray-100">
        <img src="../Assets/PROJECT 4.png" alt="Dispenser Hand Sanitizer" class="w-full h-full object-cover">
      </div>

      <div class="bg-[#4B3C3C] text-white px-4 py-3 flex items-center justify-between">
        <div class="text-left leading-tight">
          <p class="text-sm font-semibold">Design ACAD</p>
          <p class="text-[11px] italic text-gray-200">Dispenser Handsanitizer</p>
        </div>
        <img src="../Assets/PANAH 2.png" class="w-4 h-4 object-contain" alt="arrow">
      </div>
    </a>

    <!-- Project 5: Mesin Pemotong Cabai -->
    <a href="detailproject(5).html" 
       class="block bg-white border border-black/40 rounded-xl shadow-sm overflow-hidden transform hover:-translate-y-1 hover:shadow-lg transition">

      <div class="h-48 bg-gray-100">
        <img src="../Assets/PROJECT 5.png" alt="Mesin Pemotong Cabai" class="w-full h-full object-cover">
      </div>

      <div class="bg-[#4B3C3C] text-white px-4 py-3 flex items-center justify-between">
        <div class="text-left leading-tight">
          <p class="text-sm font-semibold">Design ACAD</p>
          <p class="text-[11px] italic text-gray-200">Mesin Pemotong Cabai</p>
        </div>
        <img src="../Assets/PANAH 2.png" class="w-4 h-4 object-contain" alt="arrow">
      </div>
    </a>
