...
CREATE TABLE
  `project` (
    ...
    `durasi_project` varchar(50) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
      `tanggal_project` date DEFAULT NULL,
      `tipe_pengerjaan_project` varchar(50) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
      `link_project` varchar(255) DEFAULT NULL,
      `deskripsi_project` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_0900_ai_ci,
      `gambar_project` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE
  `sharing` (
    `id` int NOT NULL,
    `judul_content` varchar(150) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
      `subJudul_content` varchar(150) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
      `deskripsi_content` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_0900_ai_ci,
      `gambar_content` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE
  `pengunjung` (
    `id` int NOT NULL,
    `nama` varchar(150) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
      `email` varchar(150) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
      `message` varchar(250) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
--
ALTER TABLE `certificate` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `sharing` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `pengunjung` MODIFY COLUMN id INT AUTO_INCREMENT PRIMARY KEY;
--
-- AUTO_INCREMENT for table `certificate`
--
ALTER TABLE `certificate` MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `biodata`
--
ALTER TABLE `biodata` MODIFY `id` int NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 6;

--
-- AUTO_INCREMENT for table `project`
--
ALTER TABLE `project` MODIFY `id` int NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 3;

--
-- AUTO_INCREMENT for table `sharing`
--
ALTER TABLE `sharing` MODIFY `id` int NOT NULL AUTO_INCREMENT;
